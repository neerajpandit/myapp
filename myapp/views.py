...
class PaperView(ListView):
    def get(self,request):
        ...
        return render(request,'myapp/paper.html',{'opsem':opsem,'opbranch':opbranch,'opyear':opyear,'result':result})
...
class NotesView(ListView):
    def get(self,request):
        ...
        opsem=Semester.objects.all()
        opbranch=Branch.objects.all()
        return render(request,'myapp/notes.html',{'notesresult':notesresult,'opsem':opsem,'opbranch':opbranch})
...
class SyllabusView(ListView):
    def get(self,request):
        ...
        opsem=Semester.objects.all()
        opbranch=Branch.objects.all()
        return render(request,'myapp/syllabus.html',{'syllabusresult':syllabusresult,'opsem':opsem,'opbranch':opbranch})
...
class TimetableView(ListView):
    def get(self,request):
        ...
        opsem=Semester.objects.all()
        opbranch=Branch.objects.all()
        return render(request,'myapp/timetable.html',{'timetableresult':timetableresult,'opsem':opsem,'opbranch':opbranch})
